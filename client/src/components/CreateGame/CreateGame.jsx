...
function CreateGame() {
    ...
    const handleSubmit = e => {
        ...
        validate(form);
        let checkboxsErrors = []
        if (form.genres.length < 1) checkboxsErrors.push('Genres required');
        if (form.platforms.length < 1) checkboxsErrors.push('Platforms required');
        if (Object.values(errors).length || checkboxsErrors.length) {
            return alert(Object.values(errors).concat(checkboxsErrors).join('\n'));
        }
        axios.post('http://localhost:3001/createVideogame', form)
        alert(`${form.name} game created😊!!! `)
        ...
        <div className={s.creategame}>
            ...
            <div className={s.wrapper}>
                <div className={s.container}>
                    <h1 className={s.title}>CREATE NEW GAME</h1>
...
//     return (
//         <div>
//             <Link to= '/videogame'><button></button></Link>
//             <h1>CREA TU GAME GRATIS</h1>
//             <form>
//                 <div>
//                     <lavel>Nombre</lavel>
//                     <lavel></lavel>
